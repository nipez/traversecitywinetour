...
PAGE_TITLES = {
    ...
    "journal/best-lake-view-wineries-traverse-city.html": "Best Lake View Wineries | Traverse City Wine Trail",
    "journal/best-pinot-noir-traverse-city.html": "Best Pinot Noir in Traverse City | Michigan Wine Guide",
...
PAGE_DESCS = {
    ...
    "journal/index.html": "Traverse City wine-country guides: Pinot Noir picks, lake-view wineries, first-timer tasting tips, peninsula comparisons, Riesling, and weekend itineraries.",
    ...
    "journal/best-lake-view-wineries-traverse-city.html": "Discover Traverse City wineries with the best lake and bay views on Old Mission and Leelanau — Chateau Chantal, 2 Lads, Bel Lago, Brys Estate, and more.",
    "journal/best-pinot-noir-traverse-city.html": "Find the best Pinot Noir in Traverse City wine country — cool-climate bottles from Shady Lane, 2 Lads, Bel Lago, Bonobo, Gill's Pier, and more.",
